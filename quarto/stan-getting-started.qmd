...
# A. Bayesian statistics {.unnumbered}

In this appendix, we provide more formal definitions of the mathematics of Bayesian statistics.

## A.0 Probability theory
...
A _sigma algebra_ $\mathcal{S}$ is a set of subsets of $\Omega$,
$\mathcal{S} \subsetq \textrm{pow}(\Omega)$, that satisfy three
properties,

* *unit*: $\emptyset \in \mathcal{S}$
* *closed under complements*: if $A \in \mathcal{S},$ then $A^{\comp} \in
...
## A.1 Bayes's theorem {.unnumbered}
